...
<head>
    ...
    <title>Your Business Name | साना व्यवसायहरूको लागि डिजिटल सेवाहरू</title>
    <style>
        body {
            ...
            box-sizing: border-box; /* Ensure consistent box model sizing */
            width: 100vw; /* Make the body take up the full width of the viewport */
...
<section id="about" class="container">
    ...
    <p class="lang-ne">हामी नेपालका साना व्यवसायहरूलाई अनलाइन उपस्थिति स्थापना गर्न मद्दत गर्छौं। तपाईंलाई इ-कमर्स वेबसाइट, सामाजिक सञ्जाल मार्केटिङ, वा निरन्तर समर्थन चाहिन्छ भने, हामी तपाईंको आवश्यकताहरूलाई पूरा गर्न किफायती समाधानहरू प्रस्ताव गर्छौं।</p>
    <p class="lang-en" style="display: none;">We specialize in helping small businesses in Nepal establish an online presence. Whether you need an e-commerce website, social media marketing, or ongoing support, we offer affordable solutions tailored to your needs.</p>
</section>

<!-- Services Section -->
<section id="services" class="container">
    <h2 class="lang-ne">हामी को हौं</h2>
    <h2 class="lang-en" style="display: none;">Who We Are</h2>
    
    <div class="services">
        <div class="service-box">
            <img class="lang-ne" src="https://i.imgur.com/wpY9akj.jpeg" alt="E-Commerce Setup" style="width: 410px; height: auto;">
            <img class="lang-en" style="display: none; width: 410px; height: auto;" src="https://i.imgur.com/wpY9akj.jpeg" alt="E-Commerce Setup">
        </div>
        
        <div class="service-box">
            <h3 class="lang-ne">हामी को हौं</h3>
            <h3 class="lang-en" style="display: none;">Who We Are</h3>
            <p class="lang-ne">हामी दुई फरक संसारका मानिस हौं—युरोपको सर्बिया र एसियाको नेपाल। हाम्रो यात्राले हामीलाई एकसाथ ल्यायो, र २०२२ मा हामी नेपालमा विवाह गर्यौं। हाल हामी माल्टामा बस्छौं।</p>
            <p class="lang-en" style="display: none;">We are a married couple from two different worlds—Serbia in Europe and Nepal in Asia. Our journey brought us together, and in 2022, we were married in Nepal. Currently, we live in Malta.</p>
            <div class="logo">
                <img src="https://i.imgur.com/EbmPSd4.jpeg" alt="Logo" style="width: 190px; height: auto;">
            </div>
        </div>
        
        <div class="service-box">
            <div class="logo">
                <img src="https://i.imgur.com/E7lgGLl.jpeg" alt="Logo" style="width: 190px; height: auto;">
            </div>
            <div class="logo">
                <img src="https://i.imgur.com/AjoMEw4.jpeg" alt="Logo" style="width: 190px; height: auto;">
            </div>
            <div class="logo">
                <img src="https://i.imgur.com/gQhza8R.jpeg" alt="Logo" style="width: 190px; height: auto;">
            </div>
        </div>
    </div>
</section>
<!-- Contact Section - Specialized Solutions -->
<section id="contact-solutions" class="container">
    <h2 class="lang-ne">विशेष समाधानहरू</h2>
    ...
    <h2 class="lang-ne">मोबाइल स्टोरहरू</h2>
    ...
    <h2 class="lang-ne">किराना पसलहरू</h2>
    <h2 class="lang-en" style="display: none;">Grocery Stores</h2>
    ...
    <h2 class="lang-ne">लुगा खुद्रा विक्रेताहरू</h2>
...
<!-- About Section 3 -->
<section id="about" class="container">
    <h2 class="lang-ne">डिजिटल दौडमा अरूलाई अघि बढ्न नदिनुहोस्!</h2>
    <h2 class="lang-en" style="display: none;">Don't let others get ahead in the digital race!</h2>
    <p class="lang-ne">
        आजको द्रुत गतिमा अघि बढ्ने संसारमा अनलाइन हुनु विकल्पमात्र होइन, यो आवश्यकता हो। तपाईं ल्यापटप, मोबाइल फोन वा गहनाहरू बेच्दै हुनुहुन्छ भने, अनलाइन जानु तपाईंको आम्दानी बढाउन र तपाईंको सानो व्यवसायलाई ठूलो बनाउन सहयोग गर्नेछ। हामी तपाईंलाई तपाईंको डिजिटल ब्रान्ड बनाउन मद्दत गर्नेछौं र प्रतिस्पर्धामा अगाडि राख्नेछौं। सम्झनुहोस्, डिजिटल युगलाई आत्मसात गर्न नसक्नेहरू पछाडि परेका व्यवसाय बन्नेछन्। आजै सुरु गर्नुहोस्, र तपाईंको व्यवसायलाई बढ्दै गएको हेर्नुहोस्!
    </p>
    <p class="lang-en" style="display: none;">
        In today’s fast-moving world, being online is not just an option, it’s a necessity. Whether you’re selling laptops, mobile phones, or jewelry, moving online will boost your revenue and transform your small business into a big one. Let us help you create your digital brand and stay ahead of the competition. Remember, those who fail to adapt to the digital age risk being left behind. Start today, and watch your business grow!
    </p>
</section>
<!-- Services Section 2-->
<section id="services" class="container">
    <h2 class="lang-ne">सेवाहरूको संक्षिप्त अवलोकन</h2>
    ...
    <div class="services">
        ...
        <div class="service-box">
            <h3 class="lang-ne">डिजिटल विज्ञापन</h3>
            <h3 class="lang-en" style="display: none;">Digital Advertising</h3>
            <p class="lang-ne">लक्षित डिजिटल विज्ञापन अभियानहरूको माध्यमबाट थप क्लिक, लिड्स, र बिक्रीहरू प्राप्त गर्नुहोस्। हामी फेसबुक विज्ञापन, गुगल विज्ञापन र थपलाई सम्हाल्छौं जसले महत्त्वपूर्ण नतिजाहरू ल्याउँछ।</p>
        ...
        <div class="service-box">
            <h3 class="lang-ne">सर्च इञ्जिन अप्टिमाइजेसन (SEO)</h3>
            <h3 class="lang-en" style="display: none;">Search Engine Optimization (SEO)</h3>
            <p class="lang-ne">गुगलमा उच्च स्थानमा र्‍याङ्क गर्नुहोस्! हाम्रो SEO रणनीतिहरू तपाईंको वेबसाइटको ट्राफिक र दृश्यता बढाउन डिजाइन गरिएको छ, जसले ग्राहकहरूलाई अनलाइन तपाईंलाई सजिलैसँग भेट्न मद्दत गर्छ।</p>
...
<section id="services" class="container">
    ...
    <div class="services">
        ...
        <div class="service-box">
            ...
            <div class="service-box">
                <img class="lang-ne" src="https://i.imgur.com/xGXWCgx.png" alt="Affordable Packages" style="width: 210px; height: auto;" />
                <img class="lang-en" style="display: none;float: center;  width: 250px; height: auto;" src="https://i.imgur.com/xGXWCgx.png" alt="Affordable Packages" />
            </div>
        </div>
        ...
        <div class="service-box">
            ...
            <div class="service-box">
                <img class="lang-ne" src="https://i.imgur.com/P4KRpBA.png" alt="Flexible Payment Plans" style="width: 210px; height: auto;" />
                <img class="lang-en" style="display: none; float: center; width: 250px; height: auto;" src="https://i.imgur.com/P4KRpBA.png" alt="Flexible Payment Plans" />
            </div>
        </div>
    </div>
</section>
<!-- About Section -->
<section id="about" class="container">
    <h2 class="lang-ne">आफ्नो व्यापार सुधार गर्ने अवसर नछुटाउनुहोस् र अनलाइन बिक्री सुरू गर्नुहोस्!</h2>
    <h2 class="lang-en" style="display: none;">Don't Miss the Opportunity to Improve Your Business and Start Selling Online!</h2>
    <p class="lang-ne">डिजिटल संसार कहिल्यै भन्दा छिटो विकसित भइरहेको छ, र जसले अनुकूलन गर्दैनन् तिनीहरूको व्यापार पछाडि पर्ने खतरा छ। एउटा कदम पछाडि नहोस् — एक कदम अगाडि रहनुहोस्! आफ्नो व्यापारलाई अनलाइन ल्याउँदा, तपाईंले नयाँ आम्दानीका स्रोतहरू मात्र खोल्नुहुन्न, तर आफ्नो ब्रान्डलाई प्रतिस्पर्धी बनाउन पनि सुनिश्चित गर्नुहुन्छ।
...
Don’t wait until it’s too late. Start your journey today, and let us help you step confidently into the future.</p>
</section>
...
footer {
    background-color: #333; /* Dark background color for better contrast */
    color: #fff; /* White text color for readability */
    text-align: center; /* Center-align text */
    padding: 20px; /* Add padding for spacing */
    position: relative; /* Ensure proper placement on the page */
    bottom: 0;
    width: 100%;
}
...
footer .lang-en, footer .lang-ne {
    display: block; /* Ensure content is displayed properly */
}
</style>
<!-- Contact Section -->
<section id="contact" class="container">
    ...
    <p class="lang-ne">इमेल: <a href="mailto:advibenepal7@gmail.com">advibenepal7@gmail.com</a></p>
    <p class="lang-en" style="display: none;">Email: <a href="mailto:advibenepal7@gmail.com">advibenepal7@gmail.com</a></p>
    <p class="lang-ne">निःशुल्क परामर्श</p>
    ...
    <div>
        ...
        <a href="https://chat.whatsapp.com/LJDFcJAzqDp9ryHGVR8npy" target="_blank">
            <button class="lang-ne" style="background-color: #25D366; color: white; padding: 10px 20px; border: none; border-radius: 5px; cursor: pointer;">
                हामीसँग WhatsApp मा कुरा गर्नुहोस्।
            </button>
        </a>
